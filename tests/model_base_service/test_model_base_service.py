...
#         first_models = MockModelBase.add(MockModelBase(name=testing_first_name))
...
#         create_model = MockModelBase.add(MockModelBase(name=model_to_delete))
...
#         )
#         MockModelBase.add_all(model_list)
#         MockModelBase.clean_all()
...
#         find_prev_model = MockModelBase.get_by_id(model_id=prev_model_id)
...
#         find_prev_mode: MockModelBase = MockModelBase.get_by_id(model_id=prev_model_id)
